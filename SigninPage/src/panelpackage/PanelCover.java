...
public class PanelCover extends javax.swing.JPanel {
    ...
    public PanelCover() {
     ...
     private void init() {
        title = new JLabel("Already a Member?");
        ...
        button.setBackground(new Color(164, 113, 230));
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gra=new GradientPaint(0, 0, new Color(230,230,250), 0, getHeight(), new Color(176,156,200));
        g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                title.setText("Already a Member?");

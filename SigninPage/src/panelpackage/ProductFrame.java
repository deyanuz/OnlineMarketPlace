...
public class ProductFrame extends javax.swing.JFrame {
    ...
    public ProductFrame(Product product, SellerPage sp) {
        initComponents();
        SetProduct(product, sp);
    }

    public void SetProduct(Product product, SellerPage sp) {
        ImagePanel.setLayout(new MigLayout("wrap", "push[center]", "push[center]push"));
        ...
        ImagePanel.add(j);
        JPanel productPanel = new JPanel(new MigLayout("wrap", "push[]push", "push[]push"));
    ...
    private void initComponents() {
        ...
        ImagePanel.setPreferredSize(new java.awt.Dimension(160, 300));
        ...
        jLayeredPane2Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane2Layout.createSequentialGroup()
                .addComponent(ImagePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
